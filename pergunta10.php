    ...
    <div class="container bg-white">
        ...
        <sp"
            ...
            <div class="col-sm-6 offset-3 text-center mt-3" >
                ...
                <h2 class ="text-center">10.O invólucro onde os componentes eletrônicos como placa de vídeo e placa de som são dispostos em um computador convencional é denominado </h2>
