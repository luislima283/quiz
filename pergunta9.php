    ...
    <div class="container bg-white">
        ...
        <sp"
            ...
            <div class="col-sm-6 offset-3 text-center mt-3" >
                ...
                <h2 class ="text-center">9.Há um tipo de mouse que utiliza um LED como emissor de luz, sendo essa luz captada por sensores, conforme se movimenta o mouse. Esse tipo de mouse é conhecido como </h2>
                <form method="post" action="pergunta10.php">
