    ...
    <div class="container bg-white">
        ...
        <sp"
            ...
            <div class="col-sm-6 offset-3 text-center mt-3" >
                ...
                <h2 class ="text-center">7.A memória cache </h2>
                        ...
                        <ul class="list-group text-left">
                            <li class="list-group-item">
                                <label>
                                    ...
                                    é usada para maximizar a disparidade existente entre a velocidade do processador e a velocidade de leitura e gravação de dados.
                                </label>
                            </li>
                            ...
                            <li class="list-group-item">
                                <label>
                                    ...
                                    é uma memória volátil de alta velocidade, porém com pequena capacidade de armazenamento.
                                </label>
                            </li>
                            ...
                            <li class="list-group-item">
                                <label>
                                    ...
                                    armazena a maioria do conteúdo da memória principal.
                                </label>
                            </li>
                        </ul>
